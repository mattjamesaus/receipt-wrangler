# openapi.model.ReceiptPagedRequestFilter
...
**documentCurrency** | [**JsonObject**](.md) | Contains two keys: operation of type FilterOperation and value which can a different type depending on the field. | [optional]
**fxStatus** | [**JsonObject**](.md) | Contains two keys: operation of type FilterOperation and value which can a different type depending on the field. | [optional]
