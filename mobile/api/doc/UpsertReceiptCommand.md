...
**amount** | **String** | Effective base-currency amount; required for compatibility and confirmed FX values |
**documentAmount** | **String** | Original total printed on the receipt; defaults to amount when omitted | [optional]
**documentCurrencyCode** | **String** | ISO 4217 currency printed on the receipt; defaults to the group base currency | [optional]
**fxStatus** | [**FxStatus**](FxStatus.md) |  | [optional]
